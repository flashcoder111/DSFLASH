...
export const articles: Article[] = [
  {
    ...
    dek: "Meta’s 30B open-weight multimodal model uses two KV heads across a 131K-token context. That does not settle model quality, but it is a meaningful design choice for long-running local agents.",
    topic: "AI Agents",
    topicSlug: "ai-agents",
    date: "August 12, 2026",
    ...
    sections: [
      {
        heading: "A deliberate local-plus-global attention pattern",
        paragraphs: [
      ...
      {
        heading: "Two KV heads change the memory math",
        paragraphs: [
      ...
      {
        heading: "Why that matters for local agent workloads",
        paragraphs: [
      ...
      {
        heading: "The benchmark graphic is a starting point, not a verdict",
        paragraphs: [
      ...
      {
        heading: "Open weights make the claim testable",
        paragraphs: [
